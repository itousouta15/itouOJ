...
export function pdfUpdateData(
  pdfUpload: { filename: string; base64: string } | null | undefined
): { pdfData?: Uint8Array<ArrayBuffer> | null; pdfFilename?: string | null; pdfUploadedAt?: Date | null } {
  if (pdfUpload === undefined) return {};
  if (pdfUpload === null) {
    return { pdfData: null, pdfFilename: null, pdfUploadedAt: null };
  }
